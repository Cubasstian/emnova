...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-warning">
            <a href="ideas/misIdeas/" class="brand-link elevation-2 navbar-success">
                <img src="dist/img/logote.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-4" style="opacity: .8">
                <span class="brand-text font-weight-light text-white"><b>EmNOVA <small style="font-size: 10px">v0.5</small></b></span>
            </a>
            <div class="sidebar">
                <nav class="mt-2">
